...
Este proyecto consiste en el desarrollo de una aplicación sencilla de reservación de tiquetes aéreos, creada en Java (Swing), que simula un sistema de aerolínea.
